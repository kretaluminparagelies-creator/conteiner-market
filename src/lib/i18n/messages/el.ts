...
export const el = {
  ...
  stats: {
    items: {
      ...
      monthlyRental: {
        title: "Μηνιαία Ενοικίαση Container & Χώρου",
        detail:
          "Ιδανική λύση για σταθερή αποθήκευση ή επαγγελματική χρήση. Ενοικίαση container ή/και εξωτερικού χώρου με διάρκεια από 1 μήνα και άνω, με ευελιξία ανανέωσης.",
      },
    },
    details: {
      conversions: {
      ...
      monthlyRental: {
        number: "06",
        title: "Μηνιαία Ενοικίαση Container & Χώρου",
        subtitle: "Σταθερή / μακροχρόνια ενοικίαση",
        intro:
          "Η επιλογή απευθύνεται σε πελάτες που χρειάζονται σταθερό χώρο για μεσαία ή μακροχρόνια χρήση. Μπορεί να χρησιμοποιηθεί για αποθήκευση εμπορευμάτων, εξοπλισμού ή επαγγελματικών αναγκών. Προσφέρεται ευελιξία στη διάρκεια, με ελάχιστη δέσμευση τον 1 μήνα και δυνατότητα επέκτασης χωρίς επαναδιαπραγμάτευση.",
        bulletsIntro: "Κύρια χαρακτηριστικά:",
        bullets: [
          "Ελάχιστη διάρκεια: 1 μήνας",
          "Επιλογή container ή ανοιχτού χώρου",
          "Σταθερή χρέωση ανά μήνα",
          "Δυνατότητα ανανέωσης χωρίς διακοπή",
          "Κατάλληλο για επαγγελματική χρήση ή αποθήκευση",
        ],
        outro:
          "Ξεχωρίζει από τις βραχυχρόνιες επιλογές — ιδανική όταν χρειάζεστε σταθερότητα και προβλέψιμη μηνιαία χρέωση.",
        ctaLabel: "Ζήτα προσφορά για μηνιαία ενοικίαση",
  ...
  help: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Πατήστε την κάρτα της προσφοράς που σας ενδιαφέρει. Θα δείτε φωτογραφίες, τιμή, κατάσταση και περιγραφή. Στο κινητό, αλλάξτε προσφορά με τα βέλη ‹ › ή με swipe.",
      },
      {
        question: "Πώς επικοινωνώ για αγορά ή ενοικίαση;",
        answer:
          "Πατήστε «Επικοινωνία» στο μενού ή μέσα στις λεπτομέρειες της προσφοράς. Στείλτε email ή καλέστε — χωρίς ενδιάμεσους.",
      },
      {
