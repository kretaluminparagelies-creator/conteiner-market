...
export const el = {
  ...
  listings: {
    ...
    catalogHint:
      "Δικά μας κοντέινερ προς αγορά ή ενοικίαση — σύρε ή πάτα, κλικ στην κεντρική κάρτα για λεπτομέρειες.",
  ...
  help: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Δείχνει πού βρίσκεται το κοντέινερ ή από πού γίνεται παράδοση. Η αναζήτηση δεν φιλτράρει ανά πόλη — επικοινωνήστε μας για διαθεσιμότητα.",
      },
      {
