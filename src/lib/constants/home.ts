...
export const polisiPhotoImageClass =
  "object-cover object-center saturate-[0.82] contrast-[1.04]";
...
export const homePhotoImageClass =
  "object-cover saturate-[1.15] contrast-[1.08]";

export const homePhotoOverlayPrimaryClass =
  "bg-linear-to-b from-white/38 via-white/12 to-white/28";
