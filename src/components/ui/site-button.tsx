/**
 * @file site-button.tsx
 * @description Legacy site button with href support — brand variants
 * @author Katsoulakis
...
type SiteButtonProps = ButtonAsButton | ButtonAsLink;

const variantClasses: Record<ButtonVariant, string> = {
  primary: "bg-cm-accent text-white hover:bg-[#f08848] hover:-translate-y-0.5 active:translate-y-0",
  secondary:
